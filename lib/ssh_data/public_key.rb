module SSHData
  module PublicKey
    ...
    ALGO_MLDSA44ED25519 = "ssh-mldsa44-ed25519@openssh.com"
    ...
    ALGOS = [
      ...
      ALGO_ED25519, ALGO_SKECDSA256, ALGO_SKED25519, ALGO_MLDSA44ED25519
    ]
    ...
    def self.from_data(data)
      ...
      when ALGO_SKECDSA256
        SKECDSA.new(**data)
      when ALGO_MLDSA44ED25519
        MLDSA44ED25519.new(**data)
      else
...
require "ssh_data/public_key/mldsa44ed25519"
